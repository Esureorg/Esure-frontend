  ...
  return (
    <main>
      ...
      <section className="hero shell" id="top">
        ...
        <div className="hero-orbit" aria-hidden="true"><div className="orbit orbit-one" /><div className="orbit orbit-two" /><span className="orbit-core">E</span><i className="satellite one" /><i className="satellite two" /></div>
      </section>
